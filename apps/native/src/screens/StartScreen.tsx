...
const getImageRow = (imageArr: string[]) =>
  imageArr.map((image) => (
    <Image key={image} source={image} style={{ width: 148, height: 148, borderRadius: 12 }} />
  ));
  ...
  return (
    <View style={styles.screenContainer}>
      <Marquee
        ...
        <View style={{ flexDirection: 'row', gap: 12 }}>{getImageRow(row1Images)}</View>
      </Marquee>
      <Marquee
        offset={22}
        spacing={12}
        ...
        <View style={{ flexDirection: 'row', gap: 12 }}>{getImageRow(row2Images)}</View>
      </Marquee>
      <Marquee
        offset={64}
        spacing={12}
        ...
        speed={0.25}
        style={{ paddingVertical: 6 }}>
        <View style={{ flexDirection: 'row', gap: 12 }}>{getImageRow(row3Images)}</View>
      </Marquee>
      <SafeAreaView style={styles.safeArea} edges={['bottom']}>
        ...
        <View style={styles.textContainer}>
          ...
          <VSpace size={8} />
          <Text style={[styles.subheader, styles.masterpiecesText]}>masterpieces</Text>
        </View>
